...
if (fullName === 'Brendan Eich') {
  ...
  console.log('블록 스코프:', fullName)  // 출력 : 'Guido Van Rossum'
}

console.log('전역 스코프:', fullName)  // 출력 : 'Brendan Eich'
...
console.log(lunch)      // referenceError : cannot access 'lunch'
const lunch = '초밥'
